...
function useAnimationStream(options) {
  ...
  const [framesReceived, setFramesReceived] = react.useState(0);
  const [healthStatus, setHealthStatus] = react.useState("idle");
  react.useEffect(() => {
...
exports.useAnimationStream = useAnimationStream;
